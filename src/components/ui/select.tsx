		...
		return (
			<div className="space-y-1">
				...
				<select
					...
					id={selectId}
					className={cn(
						"block w-full rounded-lg border px-3 py-2 text-gray-900 shadow-sm transition-colors focus:ring-2 focus:outline-none dark:bg-stone-900 dark:text-stone-100",
						error
